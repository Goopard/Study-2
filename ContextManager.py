...
class ExecutionInfo:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        """Method called on the exiting of the code wrapped by this context manager. Calculates time elapsed on
        the execution and if some exception was raised during the execution opens the output file, prints all the
        required information and closes the file.
        ...
        if exc_type is not None:
            ...
            print('Information on the code executed on {}:\n'
                  ...
                  .format(self.execution_datetime, self.time_elapsed), file=self.file)
